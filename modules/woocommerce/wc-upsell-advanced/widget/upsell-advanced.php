...
class stiles_wc_product_upsell_advanced extends \Elementor\Widget_Base 
{
    ...
    {
        return 'stiles-product-upsell-advanced';
    }
    
    public function get_title() 
    {
        return __( 'Product Upsell: Advanced', smw_slug );
    }
     ...
     protected function register_controls() 
    {
        ...
        $this->product_countdown_options();
        
        $this->product_slider_options();

        $this->product_title_options();
        ...
        $this->slider_buttons_style();
    }
    
    protected function product_content_layout()
    {
        // Product Content
        $this->start_controls_section(
            ...
            $this->add_control(
                ...
                [
                    ...
                    'default'     => __( 'You may also like…', smw_slug ),
    ...
    protected function product_countdown_options()
    {
        // Product countdown
        $this->start_controls_section(
    ...
    protected function product_slider_options()
    {
    ...
    protected function product_title_options()
    {
        ...
        $this->start_controls_section(
            ...
            $this->add_group_control(
                ...
                [
                    ...
                    'selector' => '{{WRAPPER}} h2.smupsell_product_title',
                ]
            );
            ...
            $this->add_control(
                ...
                [
                    ...
                    'default' =>'#444444',
                    'selectors' => [
                        '{{WRAPPER}} h2.smupsell_product_title' => 'color: {{VALUE}};',
                    ],
                ]
            );
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'size_units' => [ 'px', '%', 'em' ],
                    'selectors' => [
                        '{{WRAPPER}} h2.smupsell_product_title' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                    ],
                ]
            );
    ...
    protected function default_style()
    {
    ...
    protected function slider_buttons_style()
    {
        // Slider Button style
        $this->start_controls_section(
    ...
    protected function render( $instance = [] ) 
    {
        ...
        {
            $product = wc_get_product( stiles_get_last_product_id() );
        } else{
        ...
        if( $columns !='' ){
            if( $columns == 5 ){
                $columnval = 'sm-product cus-col-5 sm-col-md-6 sm-col-sm-6 sm-col-xs-12 mb-30 product';
            }else{
        ...
        if( $settings['product_content_style'] == 2 ){
            $columnval .= ' sm-product-category-rigsm-bottom';
    ...
    ?>
        <?php
            if( $settings['upsell_product_title'] !='' ){
                echo '<div class="sm-row"><div class="sm-col-lg-12 sm-col-md-12 sm-col-sm-12 sm-col-xs-12"><h2 class="smupsell_product_title">'.esc_html__( $settings['upsell_product_title'], smw_slug ).'</h2></div></div>';
            }
        ?>
...
Plugin::instance()->widgets_manager->register_widget_type( new stiles_wc_product_upsell_advanced() );