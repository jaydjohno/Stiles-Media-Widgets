...
/**
 * Stiles Media Widgets Checkout: Shipping.
 *
 * @package SMW
 */
...
class stiles_wc_checkout_shipping extends Widget_Base 
{
    ...
    {
        return 'stiles-checkout-shipping';
    }
    
    public function get_title() 
    {
        return __( 'Checkout: Shipping', smw_slug );
    }
    ...
    protected function shipping_fields()
    {
        // Manage Field
        $this->start_controls_section(
    ...
    protected function shipping_form_heading()
    {
        // Heading
        $this->start_controls_section(
            'form_heading_style',
    ...
    protected function shipping_form_label()
    {
        // Form label
        $this->start_controls_section(
            'form_label_style',
    ...
    protected function shipping_input_box()
    {
        // Input box
        $this->start_controls_section(
    ...
    protected function register_controls() 
    {
        ...
        $this->shipping_form_heading();

        $this->shipping_form_label();
    }
    ...
    protected function render() 
    {
        ...
        if( $settings['modify_field'] == 'yes' )
        {
            ...
            if( !empty( get_option( 'stiles_wc_fields_shipping' ) ) || get_option( 'stiles_wc_fields_shipping' ) )
            {
                update_option( 'stiles_wc_fields_shipping', $items );
            }else
            {
                add_option( 'stiles_wc_fields_shipping', $items );
            }

        }else{
            delete_option( 'stiles_wc_fields_shipping' );
        }
        ...
        if ( Plugin::instance()->editor->is_edit_mode() ) 
        {
            ...
            if( is_checkout() )
            {
                $checkout = wc()->checkout();
                if( sizeof( $checkout->checkout_fields ) > 0 ){ ?>
                    <div class="stiles woocommerce-shipping-fields">
...
Plugin::instance()->widgets_manager->register_widget_type( new stiles_wc_checkout_shipping() );