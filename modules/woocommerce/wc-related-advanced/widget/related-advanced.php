...
/**
 * Stiles Media Widgets Related Products: Advanced.
 *
 * @package SMW
 */
...
class stiles_wc_related_products_advanced extends \Elementor\Widget_Base 
{
    ...
    {
        return 'stiles-product-related-advanced';
    }
    
    public function get_title() 
    {
        return __( 'Related Products: Advanced', smw_slug );
    }
    ...
    protected function register_controls() 
    {
        ...
        $this->product_query_control();
        
        $this->product_content_control();
        
        $this->action_button_control();
        ...
        $this->section_title_control();
        
        $this->default_style_control();
        
        $this->product_action_button_control();
        
        $this->countdown_style_control();
        
        $this->slide_controls_style();
    }
        ...
        $this->start_controls_section(
            ...
            $this->add_control(
                ...
                [
                    ...
                    'default' => __( 'Related Product', smw_slug ),
    ...
    protected function product_query_control()
    {
        $this->start_controls_section(
            'stiles-products',
            [
    ...
    protected function action_button_control()
    {
    ...
    protected function section_title_control()
    {
    ...
    protected function countdown_style_control()
    {
    ...
    protected function slide_controls_style()
    {
        // Slider Button style
        $this->start_controls_section(
    ...
    ?>
        <?php
            if( $settings['related_product_title'] !='' ){
                echo '<div class="sm-row"><div class="sm-col-lg-12 sm-col-md-12 sm-col-sm-12 sm-col-xs-12"><h2 class="wlrelated_product_title">'.esc_html__( $settings['related_product_title'], smw_slug ).'</h2></div></div>';
            }
        ?>
                        ...
                        <div class="sm-product-inner">
                            ...
                            <div class="sm-product-content">
                                <div class="sm-product-content-inner">
                                    ...
                                    <div class="sm-product-ratting-wrap"><?php echo stiles_wc_get_rating_html_wc_get_rating_html(); ?></div>
                                    ...
                                    <?php 
                                        if( $settings['show_product_excerpt'] == 'yes' ){
                                            echo '<div class="stilesquickview-short-desc">'.wp_trim_words( get_the_excerpt(), $settings['excerpt_length'], '' ).'</div>';
                                        }
                                    ?>
...
Plugin::instance()->widgets_manager->register_widget_type( new stiles_wc_related_products_advanced() );